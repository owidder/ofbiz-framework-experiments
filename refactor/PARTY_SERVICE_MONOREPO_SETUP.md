...
- [ ] `build.gradle` für Party Service erstellen
- [ ] `PartyServiceApplication.java` implementieren
- [ ] `application.yml` konfigurieren

### Phase 2: Domain Model (Woche 2)
- [ ] JPA-Entities erstellen (Party, Person, ContactMech)
...
- [ ] DTOs und Mapper erstellen
- [ ] OpenAPI-Dokumentation
- [ ] Integration Tests

### Phase 4: Integration (Woche 4)
- [ ] OFBiz-Adapter implementieren
...
✅ **Klare Trennung:** Eigenes Gradle-Modul
✅ **Unabhängig startbar:** Eigene Main-Class, eigener Port
✅ **Einfache Entwicklung:** Im selben Repository
✅ **Parallelbetrieb:** OFBiz und Party Service gleichzeitig
✅ **Testbar:** Isolierte Tests mit Testcontainers
✅ **Migrierbar:** Später leicht in eigenes Repo verschiebbar

**Empfehlung:** Start mit dieser Struktur für PoC, später bei Erfolg in eigenes Repository migrieren.
