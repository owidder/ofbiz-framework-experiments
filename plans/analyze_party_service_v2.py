#!/usr/bin/env python3
"""
Neo4j Analyse: Party Service Abhängigkeiten - Version 2
Nutzt direkte Neo4j-Verbindung zur jQAssistant-Datenbank
"""
...
class Neo4jAnalyzer:
    ...
    def analyze_files(self):
        ...
        MATCH (caller:Method)-[:INVOKES]->(target:Method)
        WHERE target.fqn CONTAINS '.party.'
        WITH caller.sourceFile as File, count(*) as CallCount
    ...
    def analyze_classes(self):
        ...
        MATCH (caller:Method)-[:INVOKES]->(target:Method)
        WHERE target.fqn CONTAINS '.party.'
        WITH caller.declaringType as CallerClass, count(*) as CallCount
